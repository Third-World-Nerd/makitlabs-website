...
<div className="absolute top-0 right-0 h-full w-auto group">
  ...
  <img
    ...
    alt="Decorative"
    className="relative bottom-[15%] left-[40%] drop-shadow-lg transition-transform duration-300 group-hover:-translate-x-3 group-hover:-translate-y-3"
  />

  <button
    className="relative bottom-[70%] right-[7%] text-primary opacity-90 rounded-md bg-[rgba(250,250,250,0.6)] px-4 py-2 drop-shadow-lg transition-transform duration-300 group-hover:translate-x-2 group-hover:-translate-y-2"
  >
    10 Workshops
  </button>
  ...
  <img
    ...
    alt="Decorative"
    className="relative bottom-[115%] left-[20%] drop-shadow-lg w-12 h-12 transition-transform duration-300 group-hover:translate-x-4 group-hover:-translate-y-4"
  />
</div>
