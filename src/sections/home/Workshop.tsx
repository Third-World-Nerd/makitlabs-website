...
const Workshop: FC = ()=>{
  ...
  <div className="flex gap-12 md:flex-row flex-col items-center">
    ...
    <div className="relative h-[400px] w-full md:w-[40%] flex justify-end group">
      <img
        src="/photo/testimonials/Sayog Rai.jpg"
        alt="Workshop"
      ...
      />
        <img
            ...
            alt="Decorative"
            className="absolute bottom-[-10%] left-[24%] md:bottom-[-10%] md:left-[70%] drop-shadow-lg transition-transform duration-1000 group-hover:translate-x-10 group-hover:translate-y-10"
        />
